...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-emerald-800 selection:text-stone-50">
      ...
      <nav className="sticky top-0 z-50 bg-stone-50/80 backdrop-blur-md border-b border-stone-200/80">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex-shrink-0">
              <a href="#" className="text-2xl font-black tracking-tighter flex items-center gap-1.5">
                <span className="text-emerald-900">SANGEETHA</span>
            ...
            <div className="hidden md:flex space-x-6 items-center font-semibold text-sm text-stone-500 tracking-wide">
              <a href="#categories" className="hover:text-emerald-800 transition-colors">Woven Labels</a>
              <a href="#categories" className="hover:text-emerald-800 transition-colors">Heat Fusing</a>
              <a href="#categories" className="hover:text-emerald-800 transition-colors">Laser Cut</a>
              <a href="#categories" className="hover:text-emerald-800 transition-colors">Woven Badges</a>
              <a href="#products" className="hover:text-emerald-800 transition-colors">Shop Stock</a>
              <a href="#quote" className="bg-emerald-900 hover:bg-emerald-950 text-stone-50 px-5 py-2.5 rounded-xl transition-colors text-xs uppercase tracking-widest font-bold shadow-md shadow-emerald-900/15">
                Get A Quote
              </a>
            </div>
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-stone-600 hover:text-emerald-800 p-2 focus:outline-none"
              >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-stone-50 border-b border-stone-200 px-4 pt-2 pb-6 space-y-3 shadow-lg">
            ...
            <a href="#quote" onClick={() => setMobileMenuOpen(false)} className="block text-center bg-emerald-900 text-stone-50 py-3 rounded-xl font-bold text-xs uppercase tracking-widest">
              Get A Quote
            </a>
          </div>
        )}
      ...
      {/* Hero Section */}
      <header className="relative bg-gradient-to-b from-emerald-50/40 via-stone-50 to-stone-50 overflow-hidden py-20 lg:py-32 border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-stone-900 tracking-tight leading-[1.1] mb-6">
              Quality Custom Clothing <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-800 to-emerald-950 block sm:inline">Labels & Tags.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="#quote" className="bg-emerald-900 text-stone-50 px-8 py-4 rounded-xl hover:bg-emerald-950 font-bold tracking-wide text-sm shadow-xl shadow-emerald-900/20 text-center transition-all hover:-translate-y-0.5">
                GET A CUSTOM QUOTE
              </a>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 bg-white rounded-2xl border-t-4 border-amber-500 p-6 shadow-2xl shadow-emerald-950/10 flex flex-col justify-between transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="my-auto text-center">
                <div className="text-3xl font-black tracking-widest mb-1 text-emerald-900">SANGEETHA</div>
              ...
              {/* Overlapping deep emerald visual label */}
              <div className="absolute -z-10 top-6 left-8 w-full h-full bg-emerald-950 text-white rounded-2xl p-6 shadow-xl flex flex-col justify-between transform rotate-6 scale-95 opacity-95 border-b-4 border-amber-500">
                ...
                <div className="text-[9px] text-center text-emerald-200/70">100% ORGANIC COTTON BASE</div>
              </div>
            </div>
          </div>
      ...
      <section id="categories" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((cat, idx) => (
            <div key={idx} className="relative bg-white p-8 rounded-2xl border border-stone-200/70 shadow-sm shadow-stone-200/50 hover:shadow-md hover:shadow-emerald-900/5 transition-all hover:-translate-y-1.5 group overflow-hidden">
              {/* Large ghosted index watermark */}
              <span className="absolute -top-2 right-3 text-[5rem] leading-none font-black text-stone-900/[0.03] group-hover:text-emerald-900/[0.05] transition-colors select-none pointer-events-none" aria-hidden="true">{String(idx + 1).padStart(2, "0")}</span>

              {/* Gold gradient ring framing the icon */}
              <div className="relative inline-block mb-6 rounded-2xl p-[2px] bg-gradient-to-br from-amber-400/70 via-amber-500/20 to-emerald-700/20 group-hover:from-amber-400 group-hover:via-amber-500/50 group-hover:to-amber-500 transition-all duration-300">
                <div className="text-4xl bg-emerald-50 p-3 rounded-[14px] group-hover:scale-110 transition-transform duration-300">{cat.image}</div>
              </div>

              <h3 className="relative text-lg font-bold text-stone-900 mb-2 group-hover:text-emerald-800 transition-colors">{cat.title}</h3>
      ...
      <section className="bg-emerald-950 text-white py-24 border-y border-emerald-900/50 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(#34d399_1px,transparent_1px)] [background-size:18px_18px] opacity-[0.07]"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-emerald-200/60 mt-2 text-sm sm:text-base">Transparent structural workflow from initial contact to direct inventory logistics.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {orderSteps.map((step, idx) => (
              <div key={idx} className="bg-emerald-900/30 border border-emerald-800/60 rounded-2xl p-6 pt-8 relative flex flex-col justify-between group hover:border-amber-500/50 hover:bg-emerald-900/50 hover:-translate-y-1.5 transition-all duration-300 text-center overflow-hidden">
                ...
                <div className="relative">
                  {/* Gold gradient ring framing the image */}
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full p-[3px] bg-gradient-to-br from-amber-400 via-amber-500/40 to-emerald-800/40 group-hover:from-amber-300 group-hover:via-amber-400 group-hover:to-amber-500 transition-all duration-300 shadow-lg shadow-emerald-950/50 relative z-10">
                  ...
                  <p className="text-emerald-100/60 text-xs sm:text-sm leading-relaxed font-light px-1">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="products" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 gap-4">
          ...
          <button className="text-sm font-bold text-emerald-800 underline underline-offset-4 hover:text-emerald-600 transition-colors">View All Stock ({popularProducts.length})</button>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {popularProducts.map((prod) => (
            <div key={prod.id} className="bg-white rounded-2xl overflow-hidden border border-stone-200/70 shadow-sm shadow-stone-200/50 flex flex-col justify-between p-6 hover:border-emerald-800/30 hover:shadow-md hover:shadow-emerald-900/5 transition-all">
              <div>
                <div className="w-full aspect-square bg-stone-50 rounded-xl mb-4 flex items-center justify-center text-5xl relative border border-stone-100">
                  🏷️
                  {prod.badge && (
                    <span className="absolute top-2 right-2 bg-emerald-900 text-stone-50 text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-md">
                      {prod.badge}
                    </span>
                  )}
                </div>
              ...
              <div className="flex justify-between items-center pt-2 border-t border-stone-100">
                ...
                <button className="bg-stone-100 text-stone-800 text-xs font-bold px-3 py-1.5 rounded-lg hover:bg-emerald-900 hover:text-stone-50 transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
      ...
      <section id="quote" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white rounded-3xl border border-stone-200 p-8 sm:p-12 shadow-2xl shadow-emerald-950/10 relative">
          <div className="absolute top-0 right-12 transform -translate-y-1/2 bg-amber-500 text-emerald-950 font-bold text-xs uppercase px-4 py-1.5 rounded-full shadow">
          ...
          <form onSubmit={handleSubmitQuote} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input required type="text" className="w-full bg-stone-50 border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-800 focus:ring-2 focus:ring-emerald-800/10 transition-all" placeholder="e.g. Alex Sangeetha" />
              </div>
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-stone-700 mb-2">Email Address</label>
                <input required type="email" className="w-full bg-stone-50 border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-800 focus:ring-2 focus:ring-emerald-800/10 transition-all" placeholder="alex@brand.com" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <select className="w-full bg-stone-50 border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-800 focus:ring-2 focus:ring-emerald-800/10 transition-all text-stone-700">
              ...
              <div>
                ...
                <input type="number" min="100" className="w-full bg-stone-50 border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-800 focus:ring-2 focus:ring-emerald-800/10 transition-all" placeholder="Minimum 100 pcs" />
              </div>
            </div>

            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-stone-700 mb-2">Project Details & Sizing Spec</label>
              <textarea rows={4} className="w-full bg-stone-50 border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-800 focus:ring-2 focus:ring-emerald-800/10 transition-all" placeholder="Describe layout, folds (center fold, miter fold), and dimensional lengths..."></textarea>
            </div>

            <button type="submit" className="w-full bg-emerald-900 text-stone-50 font-extrabold tracking-wide py-4 rounded-xl text-sm uppercase hover:bg-emerald-950 transition-all shadow-lg shadow-emerald-900/20">
              Send Quote Request
            </button>
      ...
      {/* Footer / About Us */}
      <footer className="bg-emerald-950 text-emerald-100/60 pt-16 pb-12 border-t border-emerald-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12 border-b border-emerald-900/50">
